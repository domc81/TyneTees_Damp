    ...
    <ProtectedRoute>
      <Layout>
        <div className="space-y-6">
          <div>
            <Link href="/team/surveyors" className="inline-flex items-center gap-2 text-sm text-white/50 hover:text-white transition-colors mb-2">
              <ArrowLeft className="w-4 h-4" />
              Back to Surveyors
            </Link>
            <h2 className="text-2xl font-bold text-white mt-2">New Surveyor</h2>
