...
55 migrations exist (54 in `survey-system/supabase/migrations/` + 1 in root `supabase/migrations/`). All applied to the live TTDP database through `20260712000003` (subcontractor upsert key).
