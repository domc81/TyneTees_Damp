...
**Counts (final):** 2× P0 ✅ fixed · P1: 3 fixed (P1-3/4/5), 1 by-design (P1-1), 1 fixed-during-run (P1-2), 1 withdrawn (P1-6) · 8× P2 open · 3× P3 open.

**Update 2026-07-05 (later same day):** all four actionable P1s resolved and verified live — P1-3 send preflight, P1-4 move guards + `won_at` integrity, P1-5 photo-tier management. P1-6 withdrawn (already-correct query; the culprit is duplicate "Steven Robinson" profiles — data hygiene, not code). Remaining work is the P2/P3 polish list below.
