...
- **Quotations & reports** — quotation PDF + public accept/decline with e-signature (deposit auto-created on acceptance); report LLM narrative (OpenRouter `x-ai/grok-4.1-fast`) → section editor → published branded public page.
